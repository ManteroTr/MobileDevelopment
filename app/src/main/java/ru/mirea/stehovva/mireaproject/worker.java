...
public class worker extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button button = v.findViewById(R.id.buttonWorker);
        View.OnClickListener OnClickWork = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WorkRequest workerServer = new OneTimeWorkRequest.Builder(WorkerServer.class).build();
                WorkManager.getInstance(getActivity()).enqueue(workerServer);
            }
        };
        button.setOnClickListener(OnClickWork);
        return v;
    }
